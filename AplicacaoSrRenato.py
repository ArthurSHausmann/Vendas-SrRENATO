...
def ConsultarUmCadastroObj():
    ...
    for f in lista_ferramentas:
        print ('-',f.id, f.NomeDaFerramenta,"Marca:",f.MarcaDaFerramenta,"Condição:",f.estado_ferramentas)
    CadastroObjeto()
...
def ConsultarUmCadastroManutencao():
    ...
    for f in ferramanut:
        diainicio = FerramentasEmManutencao.get(FerramentasEmManutencao.dia_inicio == f)
        mesinicio = FerramentasEmManutencao.get(FerramentasEmManutencao.mes_inicio== f)
        anoinicio = FerramentasEmManutencao.get(FerramentasEmManutencao.ano_inicio== f)
        print ('-',f.id, "|Nome:", f.NomeDaFerramenta,"|Marca:" ,f.MarcaDaFerramenta, "|Começo da manutenção:",diainicio,'/',mesinicio,'/',anoinicio)
    CadastroManutencao()
...
def NovoCadastroManutencao():
    ...
    ferraest = Manutencao.get(Manutencao.NomeDaFerramenta == ferramenta.NomeDaFerramenta)

    print ("A ferramenta",ferramenta.NomeDaFerramenta,"foi adicionada a lista de manutenção e removida da lista de ferramentas disponiveis \nO inicio da manutenção será na data:",ferraest.dia_inicio,"/",ferraest.mes_inicio,"/",ferraest.ano_inicio)
